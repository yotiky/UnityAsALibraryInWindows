...
public class MenuItems : MonoBehaviour
{
    ...
    private static void ExecuteMagicOnionCodeGenerator()
    {
        ...
        var filePath = rootPath + "/GeneratorTools/moc";
        var exeFileName = "";
#if UNITY_EDITOR_WIN
        ...
        var psi = new ProcessStartInfo()
        {
            ...
            Arguments = $@"-i ""{rootPath}/WpfApp/Server/Server.csproj"" -o ""{Application.dataPath}/Scripts/Generated/MagicOnion.Generated.cs""",
